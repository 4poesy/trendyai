...
const MetricRow = ({ label, value }) => (
  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 0', borderBottom: '1px solid rgba(250, 204, 21, 0.15)' }}>
  ...
  if (!agent) {
    return (
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '48px 0', textAlign: 'center' }}>
        <p style={{ color: '#555555', fontSize: 14 }}>Agent not found.</p>
        <button
          onClick={() => navigate('/agent-grid')}
          style={{ marginTop: 16, color: '#facc15', background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, fontWeight: 600 }}
        >
          ← Back to Agent Grid
        </button>
      </div>
    ...
    <div style={{ maxWidth: 1280, margin: '0 auto' }} className="animate-fadeIn">
      ...
      <button
        ...
        style={{
          ...
          color: hoveredBack ? '#facc15' : '#555555', fontSize: 12, fontWeight: 500,
      ...
      <div className="crm-detail-grid" style={{ minHeight: 'calc(100vh - 180px)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          {/* Agent identity */}
          <div style={{ background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 12, padding: '28px 32px' }}>
          ...
          {/* Performance metrics */}
          <div style={{ background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 12, padding: '28px 32px' }}>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 10, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#facc15', marginBottom: 16 }}>
              Performance
            </p>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 12 }}>
              <span style={{ fontSize: 13, color: '#555555' }}>Tasks Completed</span>
              <span style={{ fontSize: 13, fontWeight: 600, color: metrics.tasks === '—' ? '#555555' : '#FFFFFF' }}>{metrics.tasks}</span>
            </div>
          </div>
          ...
          <div style={{ background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 12, padding: '28px 32px' }}>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10 }}>
              {agent.capabilities.map((cap, i) => (
                <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, fontSize: 13, color: '#888888', lineHeight: 1.6 }}>
          ...
          <div style={{ background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 12, padding: '28px 32px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 10, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#facc15' }}>
                Custom Prompt
              </p>
              <span style={{
                fontSize: 9, color: '#555555', border: '1px solid #2a2a2a',
            ...
            <textarea
              ...
              style={{
                ...
                background: '#111111', border: focusedTextarea ? '1px solid #2563eb' : '1px solid #2a2a2a',
            ...
            <div style={{ display: 'flex', gap: 8, marginTop: 14 }}>
              <button
                ...
                style={{
                  flex: 1, padding: '10px 0', background: hoveredSaveBtn ? '#eab308' : '#facc15', color: '#111111',
              ...
              <button
                ...
                style={{
                  padding: '10px 18px',
                  background: 'none', color: hoveredRetrainBtn && !retraining ? '#facc15' : '#555555',
                  border: hoveredRetrainBtn && !retraining ? '1px solid #2563eb' : '1px solid #2a2a2a', borderRadius: 8,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                background: 'none', border: 'none',
                color: hoveredResetBtn ? '#facc15' : '#555555', fontSize: 11, fontWeight: 600,
          ...
          {/* Connected status */}
          <div style={{
            padding: '8px 20px', borderTop: '1px solid #2a2a2a', flexShrink: 0,
          }}>
            <p style={{ fontSize: 11, color: '#facc15', fontWeight: 500 }}>
